...
export function Robots({ isHover,isHoverText, isPress, mouseX, mouseY,positionX,positionY,pozitionZ,path }) {
  ...
  return (
    ...
    style={isHover || isHoverText ? {width: "400px",  height: "250px"} : {width:'400px',height:'50px'}}
    >
      ...
      <MotionConfig transition={transition}>
        ...
        <motion.group
          initial={false}
          animate={isHover || isHoverText? "hover" : "rest"}
          dispose={null}
          variants={{
